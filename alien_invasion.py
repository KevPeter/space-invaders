...
class AlienInvasion:
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # check if all aliens destroyed, if so clear bullets and create new fleet
        if not self.aliens:
            self.bullets.empty()
            self._create_fleet()

    def _ship_hit(self):
        """responds to ship being hit by alien, lose 1 ship,
        clear bullets and aliens, then reset aliens and ships"""
